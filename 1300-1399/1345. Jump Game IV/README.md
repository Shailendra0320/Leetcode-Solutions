...
Breadth First Search (BFS) is the ideal approach because BFS always gives the shortest path in an unweighted graph.
...
to store all indices having the same value.
...
- same-value indices will be revisited many times
- causing TLE
